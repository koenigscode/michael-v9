...
export default function Header() {
    return (
        <header className={`${styles.header} h-screen flex justify-center items-center header`}>
            <div className="flex flex-row w-[85%] h-full">
                <div className='flex flex-col items-center justify-center h-full w-1/2'>
                    <h1 className="text-7xl font-semibold">Michael König</h1>
                    {/* eslint-disable-next-line react/jsx-no-comment-textnodes */}
                    <h2 className='text-4xl font-semibold mb-4'>// koenigscode</h2>
                    <div className='flex'>
