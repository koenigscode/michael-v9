...
export default function Imprint() {
    return <div className="imprint">
        <h1>Impressum</h1>
        Quelle: Erstellt mit dem Impressums - und Datenschutzgeneratoren der {" "}
        <a
        ...
        <p>
            ...
            keine Haftung für die Korrektheit aller Inhalte auf dieser Webseite
            übernehmen, speziell für jene die seitens Dritter bereitgestellt wurden.
        </p>
        <p>
            Sollten Ihnen problematische oder rechtswidrige Inhalte auffallen, bitten
        ...
        <p>
            ...
            müssen sie nicht auf unserem eigenen Server hochladen. Google Fonts ist
            ein wichtiger Baustein, um die Qualität unserer Webseite hoch zu halten.
            Alle Google-Schriften sind automatisch für das Web optimiert und dies
            spart Datenvolumen und ist speziell für die Verwendung bei mobilen
        ...
        <p>
            Anfragen für CSS-Assets speichert Google einen Tag lang auf Ihren Servern,
            ...
            Stylesheet ist eine Formatvorlage, über die man einfach und schnell z.B.
