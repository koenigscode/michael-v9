...
export default function About() {
    return <Section title="About me">
        <p className="text-xl text-justify">
            ...
            {" "}<a href="https://www.gu.se/en/study-gothenburg/software-engineering-and-management-bachelors-programme-n1sof">University of Gothenburg</a>{" "}
            with a strong passion for informatics.
            <br />
            I also hold a degree in Informatics from the
            {" "}<a href="https://www.htlstp.ac.at/abteilungen/informatik">HTL St. Pölten</a>{" "}
